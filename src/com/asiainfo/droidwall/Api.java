...
public final class Api {
	...
	// Messages
	public static final String STATUS_CHANGED_MSG 	= "com.asiainfo.droidwall.intent.action.STATUS_CHANGED";
	public static final String TOGGLE_REQUEST_MSG	= "com.asiainfo.droidwall.intent.action.TOGGLE_REQUEST";
	public static final String CUSTOM_SCRIPT_MSG	= "com.asiainfo.droidwall.intent.action.CUSTOM_SCRIPT";
	// Message extras (parameters)
	public static final String STATUS_EXTRA			= "com.asiainfo.droidwall.intent.extra.STATUS";
	public static final String SCRIPT_EXTRA			= "com.asiainfo.droidwall.intent.extra.SCRIPT";
	public static final String SCRIPT2_EXTRA		= "com.asiainfo.droidwall.intent.extra.SCRIPT2";
